...
Deno.serve(async (req: Request) => {
  ...
  let phoneNumber = "N/A";
  let email = "N/A";
  let laptopChoice = "N/A";

  // Parse the JSON body
  try {
    const { username: requestUsername, phoneNumber: requestPhoneNumber, email: requestEmail, laptopChoice: requestLaptopChoice } = await req.json();
    ...
    laptopChoice = requestLaptopChoice || laptopChoice; // Use the provided laptopChoice or default to "N/A"
  } catch (error) {
